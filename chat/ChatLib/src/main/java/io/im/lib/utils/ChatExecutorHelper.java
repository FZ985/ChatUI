...
public class ChatExecutorHelper {
    private final Executor mDiskIO;
    private final Executor mNetworkIO;
    private final Executor mUiExecutor;
    private final Executor mCompressExecutor;

    public final Executor mThreadPool = Executors.newFixedThreadPool(10);

    ChatExecutorHelper(Executor diskIO, Executor networkIO, Executor mainThread, Executor compressExecutor) {
        this.mDiskIO = diskIO;
    ...
    private static class SingletonHolder {
        static ChatExecutorHelper sInstance = new ChatExecutorHelper();
    }

    public static ChatExecutorHelper getInstance() {
