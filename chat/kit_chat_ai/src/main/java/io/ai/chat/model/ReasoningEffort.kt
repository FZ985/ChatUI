...
object ReasoningEffortOptions {
    ...
    private val generic = listOf(
        ReasoningOption("low", R.string.ai_settings_reasoning_low),
        ReasoningOption("medium", R.string.ai_settings_reasoning_medium),
        ReasoningOption("high", R.string.ai_settings_reasoning_high),
        ReasoningOption("xhigh", R.string.ai_settings_reasoning_xhigh)
    )

    private val deepSeek = listOf(
        ReasoningOption("off", R.string.ai_reasoning_off),
        ReasoningOption("high", R.string.ai_settings_reasoning_high),
        ReasoningOption("max", R.string.ai_reasoning_max)
    )

    private val gemini = listOf(
        ReasoningOption("none", R.string.ai_reasoning_off),
        ReasoningOption("low", R.string.ai_settings_reasoning_low),
        ReasoningOption("high", R.string.ai_settings_reasoning_high)
    )
    ...
    private val qwen = listOf(
        ReasoningOption("off", R.string.ai_reasoning_off),
        ReasoningOption("on", R.string.ai_reasoning_on)
    )
