...
fun ApiSettings.resolvedCompressionModel(): ResolvedModel? =
    resolve(compressionModel) ?: resolvedChatModel()
...
data class SavedConversationState(
    val uiMessages: List<AIChatMessage>,
    val conversationMessages: List<AIChatMessage>,
