...
class MarkdownCodeBlockView @JvmOverloads constructor(
    ...
    private val copyButton = AppCompatImageButton(context).apply {
        ...
        setImageResource(R.drawable.ai_vec_content_copy)
        ...
        contentDescription = context.getString(R.string.ai_action_copy)
    ...
    private fun copyCode() {
        ...
        Toast.makeText(context, context.getString(R.string.ai_action_copy), Toast.LENGTH_SHORT).show()
    }
}
