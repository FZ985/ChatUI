package io.chat.kit.chat.extension.component.inputpanel
    ...
    fun setInputStyle(style: InputStyle) {
        ...
        when (style) {
            InputStyle.All -> {
                ...
                binding.emoji.visibility = VISIBLE
                binding.add.visibility = VISIBLE
                binding.leftOffset.visibility = GONE
            }
            ...
            InputStyle.Emoji -> {
                ...
                binding.emoji.visibility = VISIBLE
                binding.add.visibility = GONE
                binding.leftOffset.visibility = VISIBLE
            }
