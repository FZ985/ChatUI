package io.chat.kit.chat.extension.component.emoticon;
...
public class ChatAndroidEmoji {
    ...
    public static void init(Context context) {
        ...
        int[] codes = context.getResources().getIntArray(context.getResources()
                .getIdentifier("yl_im_emoji_code", "array", context.getPackageName()));

        TypedArray array = context.getResources().obtainTypedArray(
                context.getResources().getIdentifier("yl_im_emoji_res", "array", context.getPackageName()));

        TypedArray strArray = context.getResources().obtainTypedArray(
                context.getResources().getIdentifier("yl_im_emoji_description", "array", context.getPackageName()));
    ...
    public static CharSequence ensure(String input) {
        ...
        if (useEmoji2()) {
            try {
                ...
                JLog.i(TAG, "ensure input:" + e.toString());
                cs = input;
            }
        } else {
            cs = input;
    ...
    public static void ensure(Spannable spannable, float textSize) {
        ...
        if (useEmoji2()) {
            try {
                ...
                JLog.i(TAG, "ensure spannable:" + e.toString());
                cs = spannable;
            }
        } else {
            cs = spannable;
