                ...
                if (mMediaPlayer.isPlaying()) {
                    ...
                    if (judge) {
                        ...
                        try {
                            ...
                            JLog.e(TAG, "onSensorChanged", e);
                        } finally {
                            if (fis != null) {
                                try {
                                    fis.close();
                                } catch (IOException e) {
                                    JLog.e(TAG, "startPlay", e);
                                }
                            }
                        }
    ...
    public void startPlay(final Context context, Uri audioUri, IAudioPlayListener playListener) {
        synchronized (mLock) {
            if (context == null || audioUri == null) {
                JLog.e(TAG, "startPlay context or audioUri is null.");
                return;
            }
            mContext = context;
            ...
            this.afChangeListener =
                    new AudioManager.OnAudioFocusChangeListener() {
                        public void onAudioFocusChange(int focusChange) {
                            synchronized (mLock) {
                                JLog.d(TAG, "OnAudioFocusChangeListener " + focusChange);
