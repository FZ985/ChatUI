 ...
 */
package io.im.uicommon.widgets.swiperecycler;
...
import io.im.uicommon.widgets.swiperecycler.touch.DefaultItemTouchHelper;
import io.im.uicommon.widgets.swiperecycler.touch.OnItemMoveListener;
import io.im.uicommon.widgets.swiperecycler.touch.OnItemMovementListener;
import io.im.uicommon.widgets.swiperecycler.touch.OnItemStateChangedListener;
import io.im.uicommon.widgets.swiperecycler.widget.DefaultLoadMoreView;
...
public class SwipeRecyclerView extends RecyclerView {
    ...
    public boolean isFooter(int position) {
        if (mAdapterWrapper == null) return false;
        return mAdapterWrapper.isFooter(position);
    }
