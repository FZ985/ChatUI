package io.im.uicommon.widgets.switchpanel.view
...
import io.im.uicommon.widgets.switchpanel.Constants
import io.im.uicommon.widgets.switchpanel.compat.KeyboardHeightCompat
import io.im.uicommon.widgets.switchpanel.device.DeviceInfo
import io.im.uicommon.widgets.switchpanel.device.DeviceRuntime
...
import io.im.uicommon.widgets.switchpanel.interfaces.TriggerViewClickInterceptor
import io.im.uicommon.widgets.switchpanel.interfaces.ViewAssertion
import io.im.uicommon.widgets.switchpanel.interfaces.listener.OnEditFocusChangeListener
import io.im.uicommon.widgets.switchpanel.interfaces.listener.OnKeyboardStateListener
...
import io.im.uicommon.widgets.switchpanel.log.LogFormatter
import io.im.uicommon.widgets.switchpanel.log.LogTracker
import io.im.uicommon.widgets.switchpanel.utils.DisplayUtil
import io.im.uicommon.widgets.switchpanel.utils.DisplayUtil.getScreenHeightWithoutSystemUI
import io.im.uicommon.widgets.switchpanel.utils.DisplayUtil.getScreenRealHeight
import io.im.uicommon.widgets.switchpanel.utils.DisplayUtil.isPortrait
import io.im.uicommon.widgets.switchpanel.utils.PanelUtil
import io.im.uicommon.widgets.switchpanel.utils.PanelUtil.getKeyBoardHeight
import io.im.uicommon.widgets.switchpanel.utils.isSystemInsetsAnimationSupport
import io.im.uicommon.widgets.switchpanel.view.content.IContentContainer
import io.im.uicommon.widgets.switchpanel.view.panel.IPanelView
import io.im.uicommon.widgets.switchpanel.view.panel.PanelContainer
...
class PanelSwitchLayout : LinearLayout, ViewAssertion {
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        deviceRuntime?.let {
            ...
            allHeight -= if (currentTopY < 0 && stableTopY >= 0) stableTopY else currentTopY.coerceAtLeast(
                0
            )
