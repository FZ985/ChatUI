...
import static io.im.uicommon.widgets.swiperecycler.SwipeRecyclerView.LEFT_DIRECTION;
import static io.im.uicommon.widgets.swiperecycler.SwipeRecyclerView.RIGHT_DIRECTION;
...
class AdapterWrapper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        contentView = mInflater.inflate(R.layout.swipe_recycler_view_item, parent, false);
