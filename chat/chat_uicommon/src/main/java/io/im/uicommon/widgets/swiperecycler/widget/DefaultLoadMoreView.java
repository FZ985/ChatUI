 ...
 */
package io.im.uicommon.widgets.swiperecycler.widget;
...
public class DefaultLoadMoreView extends LinearLayout implements SwipeRecyclerView.LoadMoreView, View.OnClickListener {
    ...
    public DefaultLoadMoreView(Context context, @Nullable AttributeSet attrs) {
        ...
        inflate(getContext(), R.layout.swipe_recycler_view_load_more, this);
    ...
    public void onLoading() {
        ...
        mTvMessage.setText(R.string.swipe_recycler_load_more_message);
    }
    ...
    public void onLoadFinish(boolean dataEmpty, boolean hasMore) {
        if (!hasMore) {
            ...
            if (dataEmpty) {
                ...
                mTvMessage.setVisibility(VISIBLE);
                mTvMessage.setText(R.string.swipe_recycler_data_empty);
            } else {
                mProgressBar.setVisibility(GONE);
                mTvMessage.setVisibility(VISIBLE);
                mTvMessage.setText(R.string.swipe_recycler_more_not);
            }
        } else {
    ...
    public void onWaitToLoadMore(SwipeRecyclerView.LoadMoreListener loadMoreListener) {
        ...
        mProgressBar.setVisibility(GONE);
        mTvMessage.setVisibility(VISIBLE);
        mTvMessage.setText(R.string.swipe_recycler_click_load_more);
    }
    ...
    public void onLoadError(int errorCode, String errorMessage) {
        ...
        mTvMessage.setVisibility(VISIBLE);
        mTvMessage.setText(
                TextUtils.isEmpty(errorMessage) ? getContext().getString(R.string.swipe_recycler_load_error) : errorMessage);
    }
