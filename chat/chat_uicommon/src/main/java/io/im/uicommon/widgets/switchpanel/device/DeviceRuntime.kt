package io.im.uicommon.widgets.switchpanel.device
...
class DeviceRuntime(val context: Context, val window: Window) {
    ...
    var deviceInfoP: io.im.uicommon.widgets.switchpanel.device.DeviceInfo? = null
    var deviceInfoL: io.im.uicommon.widgets.switchpanel.device.DeviceInfo? = null
