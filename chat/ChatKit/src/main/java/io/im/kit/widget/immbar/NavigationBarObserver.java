...
import static io.im.kit.widget.immbar.Constants.IMMERSION_NAVIGATION_BAR_MODE_DEFAULT;
import static io.im.kit.widget.immbar.Constants.IMMERSION_NAVIGATION_BAR_MODE_EMUI;
import static io.im.kit.widget.immbar.Constants.IMMERSION_NAVIGATION_BAR_MODE_MIUI;
import static io.im.kit.widget.immbar.Constants.IMMERSION_NAVIGATION_BAR_MODE_MIUI_HIDE;
import static io.im.kit.widget.immbar.Constants.IMMERSION_NAVIGATION_BAR_MODE_OPPO;
import static io.im.kit.widget.immbar.Constants.IMMERSION_NAVIGATION_BAR_MODE_SAMSUNG;
import static io.im.kit.widget.immbar.Constants.IMMERSION_NAVIGATION_BAR_MODE_SAMSUNG_GESTURE;
import static io.im.kit.widget.immbar.Constants.IMMERSION_NAVIGATION_BAR_MODE_SAMSUNG_GESTURE_TYPE;
import static io.im.kit.widget.immbar.Constants.IMMERSION_NAVIGATION_BAR_MODE_SAMSUNG_OLD;
import static io.im.kit.widget.immbar.Constants.IMMERSION_NAVIGATION_BAR_MODE_VIVO;
