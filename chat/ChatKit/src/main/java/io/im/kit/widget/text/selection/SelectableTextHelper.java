...
package io.im.kit.widget.text.selection;
...
public class SelectableTextHelper {
    ...
    //游标颜色
    private int mCursorHandleColor = io.im.lib.R.color.chat_theme50;
    //选择的文本颜色
    private int mSelectedColor = io.im.lib.R.color.chat_theme70;
    //开始的游标
     ...
     * @param layout   Layout
     */
    public void showSelectView(TextView textView, Layout layout, int pos, Message msg) {
    ...
    class CursorHandle extends View {
        ...
        public CursorHandle(boolean isLeft) {
            ...
            mPaint.setColor(ContextCompat.getColor(ChatSDK.getContext(), mCursorHandleColor));
