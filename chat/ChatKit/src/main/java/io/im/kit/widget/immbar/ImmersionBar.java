...
import static io.im.kit.widget.immbar.Constants.FLAG_FITS_DEFAULT;
import static io.im.kit.widget.immbar.Constants.FLAG_FITS_STATUS;
import static io.im.kit.widget.immbar.Constants.FLAG_FITS_SYSTEM_WINDOWS;
import static io.im.kit.widget.immbar.Constants.FLAG_FITS_TITLE;
import static io.im.kit.widget.immbar.Constants.FLAG_FITS_TITLE_MARGIN_TOP;
import static io.im.kit.widget.immbar.Constants.IMMERSION_BOUNDARY_COLOR;
import static io.im.kit.widget.immbar.Constants.IMMERSION_NAVIGATION_BAR_DARK_MIUI;
import static io.im.kit.widget.immbar.Constants.IMMERSION_NAVIGATION_BAR_VIEW_ID;
import static io.im.kit.widget.immbar.Constants.IMMERSION_STATUS_BAR_DARK_MIUI;
import static io.im.kit.widget.immbar.Constants.IMMERSION_STATUS_BAR_VIEW_ID;
