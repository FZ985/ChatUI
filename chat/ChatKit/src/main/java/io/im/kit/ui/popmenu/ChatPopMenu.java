...
import io.im.kit.databinding.ChatPopChatMenuBinding;
...
public class ChatPopMenu {
    ...
    public ChatPopMenu() {
        ...
        binding.bubbleLl.setBubbleColor(ContextCompat.getColor(ChatSDK.getContext(), io.im.kit.R.color.kit_chat_menu_bubble_color));
        ...
        popupWindow.setAnimationStyle(io.im.kit.R.style.ChatPopAnim);
    ...
    class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.MenuItemViewHolder> {
        ...
        public MenuAdapter.MenuItemViewHolder onCreateViewHolder(
            ...
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(io.im.kit.R.layout.chat_pop_chat_menu_item_layout, parent, false);
        ...
        class MenuItemViewHolder extends RecyclerView.ViewHolder {
            ...
            public MenuItemViewHolder(@NonNull View itemView) {
                super(itemView);
                root_ll = itemView.findViewById(io.im.kit.R.id.root_ll);
                title = itemView.findViewById(io.im.kit.R.id.menu_title);
                icon = itemView.findViewById(io.im.kit.R.id.menu_icon);
            }
        }
    }
}
