...
import io.im.kit.databinding.KitFragmentWebBinding
import io.im.kit.widget.IMBasicWebView
...
class IWebFragment : ChatBaseFragment() {
    ...
    private val binding: KitFragmentWebBinding by lazy {
        KitFragmentWebBinding.inflate(layoutInflater)
    }
